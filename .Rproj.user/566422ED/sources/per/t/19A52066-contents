...
S0 = 44  # initial index level
K = 65.0  # strike level
T = 125/252  # call option maturity
r = 0.09  # constant short rate
sigma = 0.001  # constant volatility of diffusion
...
str = range(32,43)
for i in str:
  print(fft_call(S0, i, T, r, sigma, lmbda, mu, delta))
